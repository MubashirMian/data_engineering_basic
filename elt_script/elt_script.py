...
#                 print("Succesfully connected to PostgresSQL")
#                 return True
#         except subprocess.CalledProcessError as e:
#             print(f"Error cnnecting to PostgresSQL: {e}")
#             retries += 1
#             print(
#                 f"Retrying in  {delay_seconds} seconds... (Attempt {retries}/{max_retries})"
#             )
#             time.sleep(delay_seconds)
#         print("Max retries reached. Exisiting.")
#         return False
...
#     '-f', 'data_dump.sql',
#     '-w' # don't need to enter password
# ]
...
# subprocess_env = dict(PGPASSWORD=destination_config['passoword'])
